	...
	<form class="layui-form layui-form-pane" >
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="title" lay-verify="required" placeholder="请输入通知标题" value="{{ $notice['title'] }}">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="type" lay-filter="type" lay-verify="required">
			        ...
			        @foreach($noticetypes as $noticetype)
			       	<option @if($noticetype['notice_type_code'] == $notice['type']) selected="selected" @endif value="{{ $noticetype['notice_type_code'] }}">{{ $noticetype['notice_type_name']  }}</option>
			       	@endforeach
		      	</select>
			</div>
		</div>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="text" id="notice_yxq" class="layui-input" lay-verify="required|date" name="notice_yxq" placeholder="请选择通知有效期至" value="{{ date('Y-m-d', $notice['notice_yxq']) }}">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label">通知发布人</label>
				<div class="layui-input-inline">
					<input type="text" class="layui-input" name="from_dw" lay-verify="required" placeholder="请输入通知发布人" value="{{ $notice['from_dw'] }}">
				</div>
			</div>
		</div>	
		<div class="layui-form-item">
