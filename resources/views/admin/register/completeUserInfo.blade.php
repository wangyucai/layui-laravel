...
@section("content")
	<blockquote class="layui-elem-quote news_search">
		<div class="layui-inline" style="color: red;">
		    ...
		    <span style="font-size: 15px;">上传头像照片时,请将照片扫描或拍摄为.jpg 格式，颜色模式 为 真 彩 色 （ True Color,RGB ）， 分 辨 率 为 150dpi-300dpi(Resolution ：pixels/inch),jpg 图像文件格式的存储压缩比≥75%(quality 75% optimized).</span>
		</div>
	</blockquote>
	...
	<div class="layui-form-item">
		...
		<div class="layui-inline">		
			...
			<div class="layui-input-inline">
				<input type="text" id="join_work_time" class="layui-input join_work_time" lay-verify="required|date" name="join_work_time" placeholder="参加工作时间">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-inline">		
			...
			<div class="layui-input-inline">
				<input type="text" id="join_procuratorate_time" class="layui-input join_procuratorate_time" lay-verify="required|date" name="join_procuratorate_time" placeholder="进入检察院工作日期">
			</div>
		</div>
		<div class="layui-inline">		
			<label class="layui-form-label" title="进入技术部门工作日期">进入技术部门工作日期</label>
			<div class="layui-input-inline">
				<input type="text" id="join_technical_department_time" class="layui-input join_technical_department_time" lay-verify="required|date" name="join_technical_department_time" placeholder="进入技术部门工作日期">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
	...
	<div class="layui-form-item">
		<div class="layui-inline">		
			...
			<div class="layui-input-inline">
				<input type="text" id="get_education_time" class="layui-input get_education_time" lay-verify="required|date" name="get_education_time" placeholder="最终学历毕业时间">
			</div>
		</div>
		<div class="layui-inline">		
			<label class="layui-form-label" title="获得学位时间">获得学位时间</label>
			<div class="layui-input-inline">
				<input type="text" id="get_academic_degree_time" class="layui-input get_academic_degree_time" lay-verify="required|date" name="get_academic_degree_time" placeholder="获得学位时间">
			</div>
		</div>
		<div class="layui-inline">
