layui.config({base: '/layadmin/modul/common/'}).use(['table', 'dialog', 'his'], function(){
    ...
    table.render({
        ...
        ,cols: [[ //表头
            ...
            ,{field: 'jdywfw_code', title: '司法鉴定业务范围代码'}
            ,{field: 'jdywfw_name', title: '司法鉴定业务范围名称'}
    ...
    table.on('tool(businesstab)', function(obj){
        var data = obj.data;      //获得当前行数据
        var layEvent = obj.event; //获得 lay-event 对应的值（也可以是表头的 event 参数对应的值）
        var tr = obj.tr;          //获得当前行 tr 的DOM对象

        if (layEvent == 'edit') {
            dialog.open('编辑管理员', '/admin/business/'+data.id+'/edit');
        } else if (layEvent == 'del') {
            dialog.confirm('确认删除该司法鉴定业务范围么', function () {
    ...
    // 排序
    table.on('sort(businesstab)', function (obj) {
        var cond = $('.search_input').val();
        flushTable(cond, obj);
    });
    ...
    $('.add_btn').click(function () {
        dialog.open('添加司法鉴定机构代码', '/admin/business/create');
    });
});